...
<div class="content">
    ...
    <form class="login-form" action="<?php echo e(action('Auth\AuthController@login')); ?>" method="post">
        ...
        <div class="form-group">
            ...
            <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="<?php echo e(trans('admin.email')); ?>" name="email" autocomplete="off" autofocus="1"/> </div>
        <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">Password</label>
            <input class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="<?php echo e(trans('admin.password')); ?>" name="password"  autocomplete="off" /> </div>
