            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                    <?php echo Form::open(['id' => 'page-categories-list']); ?>
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column data-table-checkable" data-toggle-link="<?php echo e(route('admin.category.toggle')); ?>" data-delete-link="<?php echo e($delete_link); ?>" data-category-link="<?php echo e($category_link); ?>">
                            <thead>
                                <tr>
