                    ...
                    <div class="col-md-12">
                        <div class="col-sm-6 col-md-6">
                            <div class="wide-banner cnt-strip">
                                <div class="image">
                                    <img class="img-responsive" data-echo="<?php echo e(asset('assets/front/assets/images/banners/4.jpg')); ?>" src="<?php echo e(asset('assets/front/assets/images/blank.gif')); ?>" alt="">
                                </div>  
                                <div class="strip">
                        ...
                        <div class="col-sm-6 col-md-6">
                            <div class="wide-banner cnt-strip">
                                <div class="image">
                                    <img class="img-responsive" data-echo="<?php echo e(asset('assets/front/assets/images/banners/5.jpg')); ?>" src="<?php echo e(asset('assets/front/assets/images/blank.gif')); ?>" alt="">
                                </div>  
                                <div class="strip">
