        ...
        <div class="container">
            ...
            <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
                <div class="upload-classified">
                    ...
                    <form method="post" action="<?php echo e(route('front.user.update')); ?>" enctype="multipart/form-data">
                        <?php echo method_field('put'); ?>

                        <?php echo $__env->make('front::auth.partials.form', ['button' => 'Cập nhật'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    </form>
                </div>
            </div>
        </div>
