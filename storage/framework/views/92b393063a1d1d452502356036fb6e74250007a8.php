        ...
        <div class="form-group">
            ...
            <select class="form-control" name="classifieds_category_id" id="classifieds_category_id">
                <?php foreach($classified_categories as $classified_category): ?>
                    <?php if ( ! ($classified_category->cart)): ?>
...
<div class="row">
    ...
    <table class="table table-bordered table-hover" id="tableID">
        ...
        <tbody>
        <?php foreach($imageList as  $value): ?>
            <tr class="product-images">
                <td>
                    <a href="<?php echo e($value->getImage()); ?>" class="fancybox-button" data-rel="fancybox-button">
                        <img class="img-responsive" src="<?php echo e($value->getImage()); ?>" alt="" style="width:84px; height:63px;"> </a>
                </td>
                <td>
                    <input type="text" class="form-control" name="" value="<?php echo e($value->cover_image); ?>"> </td>
                <td>
                    <a href="javascript:;" class="btn btn-default btn-sm delete_single" id="<?php echo e($value->id); ?>">
            ...
            $('#tableID').on("click",'.delete_single', function(event){
                ...
                if(c) {
                    $this.parents('.product-images').fadeOut(function(){
                        $.ajax({
                            url: '<?php echo e(route('front.classified.deleteFile')); ?>',
                            type: 'POST',
