        ...
        <div class="col-xs-12">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column data-table-checkable" data-delete-link="<?php echo e(route('admin.product.destroy')); ?>" data-toggle-link="<?php echo e(route('admin.product.toggle')); ?>">
                        <thead>
                            <tr>
