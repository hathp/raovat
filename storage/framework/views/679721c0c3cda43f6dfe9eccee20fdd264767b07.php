        ...
        <div class="col-xs-12">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                    ...
                    <table  class="table table-striped table-bordered table-hover table-checkable order-column data-table-checkable" data-delete-link="<?php echo e($ajax_delete_link); ?>" data-toggle-link="<?php echo e($ajax_toggle_link); ?>" data-featured-link="<?php echo e($ajax_featured_link); ?>" data-category-link="<?php echo e($ajax_category_link); ?>">
                        <thead>
                            <tr>
