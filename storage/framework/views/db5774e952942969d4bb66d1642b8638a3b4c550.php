<?php $__env->startSection('content'); ?>
    ...
    <div class="m-heading-1 border-green m-bordered">
        ...
        <a class="btn red btn-outline" href="<?php echo e(route('admin.product.create')); ?>" >Thêm sản phẩm</a>
...
<div class="row">
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="dashboard-stat red">
            ...
            <div class="details">
                <div class="number">
                    <span data-counter="counterup" data-value="<?php echo e($total_product); ?>">0</span> </div>
                <div class="desc"> Tổng số sản phẩm </div>
            </div>
            <a class="more" href="<?php echo e(route('admin.product.index')); ?>"> View more
                <i class="m-icon-swapright m-icon-white"></i>
            </a>
        </div>
    </div>
