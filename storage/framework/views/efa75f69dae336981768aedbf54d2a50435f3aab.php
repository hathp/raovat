<?php $__env->startSection('js-page-script'); ?>
    <?php echo $__env->make('product::category.partials.js', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        ...
        <div class="col-xs-8">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column data-table-checkable" data-toggle-link="<?php echo e(route('admin.product.category.toggle')); ?>" data-delete-link="<?php echo e(route('admin.product.category.destroy')); ?>" data-find-link="<?php echo e(route('admin.product.category.find')); ?>" >
                        <thead>
                        <tr>
                            <td> </td>
                            <td>
