...
<head>
    ...
    <meta property="og:image" content="<?php echo isset($fb_image) ? $fb_image : asset('/storage/setting/').$settings->getValueBySlug('og-image'); ?>"/>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" style="background: #333;">
                                        <?php foreach($countries as $countrie): ?>
                                            <li><a href="<?php echo e($countrie->setCookiesLink()); ?>" title="Rao vặt tại <?php echo e($countrie->name); ?>"><b><?php echo e($countrie->name); ?></b></a></li>
                                        <?php endforeach; ?>
                                    </ul>
                                </li>
...
<div class="container-fluid" id="logo-search">
    <div class="container">
        ...
        <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
            <a style="color: #333" href="<?php echo e(route('front.cart.index')); ?>"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Giỏ hàng (<?php echo e(count(session('carts'))); ?>)</a>
        </div>
    </div>
</div>
                ...
                <div class="content_eb" style="padding:5px 0px 22px 0px">
                    <div class="gold-content">
                        <div id="boxSelectCity">
                            <?php foreach($countries as $countrie): ?>
                                <div class="City"><a href="<?php echo e($countrie->setCookiesLink()); ?>" title="Rao vặt tại <?php echo e($countrie->name); ?>"><b><?php echo e($countrie->name); ?></b></a></div>
                            <?php endforeach; ?>
                        </div>
                    </div>
                </div>
