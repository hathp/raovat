...
class FormBuilder
{
     ...
     * @var integer
     */
    protected $inputArrayIndex;

    /**
     * name of current input
     * @var string
     */
    protected $inputArrayName;
    ...
    public function open(array $options = [])
    {
        ...
        $options = $this->html->arrayAttributes($options);
    ...
    public function label($name, $value = null, $options = [])
    {
        ...
        return '<label ' . $options . '>'. $value . $required . '</label>';
    }
    ...
    protected function getModelValueAttribute($name)
    {
        if (is_object($this->model)) {
            return $this->object_get($this->model, $this->transformKey($name));
    ...
    {
        return old($this->transformKey($name));
    }
    ...
    /**
     * Transform key from input array name to dot syntax.
     *
     * @param  string $key
     * @return string
     */
